...
<html>
	<head>
		...
		<!-- Scripts needed for the nice activity widget scrollbar -->
		<script type="text/javascript" src="<?php echo FB_OG_PLUGIN_URL; ?>js/jquery.mousewheel.js"></script>
		<script type="text/javascript" src="<?php echo FB_OG_PLUGIN_URL; ?>js/jquery.jscrollpane.js"></script>
	...
	<body>
		<div id="fb-root"></div>
		<?php if ($hide_header == false) { ?><h3 id="fb-og-activity-heading" >Friends' activity</h3><?php } ?>
		<div id="fb-og-activity" <?php if ($hide_header == true) { ?>style="border-top:1px solid #aaa;"<?php } ?>></div>
	</body>
</html>		
<?php 